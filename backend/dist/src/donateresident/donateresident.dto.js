...
exports.DonateResidentResponseDto = exports.UpdateDonateResidentDto = exports.CreateDonateResidentDto = void 0;
const swagger_1 = require("@nestjs/swagger");
const class_validator_1 = require("class-validator");
class CreateDonateResidentDto {
    donateId;
    residentId;
    status;
}
exports.CreateDonateResidentDto = CreateDonateResidentDto;
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'donate-id', description: 'ID của quyên góp' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CreateDonateResidentDto.prototype, "donateId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'resident-id', description: 'ID của cư dân' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CreateDonateResidentDto.prototype, "residentId", void 0);
__decorate([
    ...
    __metadata("design:type", String)
], CreateDonateResidentDto.prototype, "status", void 0);
...
//# sourceMappingURL=donateresident.dto.js.map